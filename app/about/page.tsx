      ...
      <main className="mx-auto max-w-4xl px-4 py-12 lg:px-8 lg:py-20">
        ...
        <section className="mb-16 grid gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-lg border border-border/40 bg-card p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We use Google Gemini AI to identify trending topics and generate comprehensive articles, then publish them automatically every 6 hours. All content is clearly disclosed as AI-assisted.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16 rounded-lg border border-border/40 bg-card p-8">
          ...
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
            {[
              { value: "4", label: "Articles per day" },
              { value: "6 hours", label: "Publish frequency" },
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            {[
              { step: "01", title: "Trend Detection", desc: "Our system monitors Google Trends every 6 hours to identify the most relevant and timely topics." },
