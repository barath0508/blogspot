            ...
            <div className="grid gap-8 lg:grid-cols-5">
              <div className="lg:col-span-2">
                ...
                <div className="mt-6 flex items-center gap-3">
                  {[
                    { label: "Twitter", href: "https://x.com", icon: <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> },
